...
1. Какие реальные рабочие проблемы компания пытается решить этой позицией
   (нагрузка, ошибки, нехватка компетенций, рост, качество, сроки, клиенты, процессы)

2. Какие риски существуют, если позиция останется незакрытой или закрыта слабым кандидатом

3. Что для компании КРИТИЧНО улучшить через этого сотрудника
...
Построить стратегию письма в логике:

PROBLEM → VALUE → DIFFERENTIATION

Определить:

1. Какую конкретную проблему вакансии кандидат решает лучше всего
2. Какие компетенции из биографии напрямую закрывают эти боли
3. В чём практическая польза кандидата для компании (результаты, стабильность, качество, скорость, автономность и т.д.)
4. Почему этот кандидат рационально выгоднее среднего соискателя

Стратегически:

- Сделать акцент не на "я умею", а на "я решаю"
- Позиционировать опыт как инструмент улучшения работы компании
- Избегать саморекламы — использовать причинно-следственную логику

Формат (внутренний):
- Проблема → Доказательство из CV → Ценность
- Ключевые аргументы выбора кандидата

### STEP 6 — CONSTRUCT THE FINAL GENERATION PROMPT

#### ⚠️ CORE LOGIC OF THE LETTER (MANDATORY)

Письмо должно явно (но естественно, без формулировок вопросов) отвечать на:

1. Какую рабочую проблему компании я закрываю этой ролью
2. В чём моя практическая ценность для процессов и результата
3. Почему выбор меня логичен и выгоден работодателю

Если письмо не отражает все три аспекта — оно считается неуспешным.
